...
#** In the batting data set, I are eager to check the runs that Ohtani has hit.
...
library(openxlsx)
sheet <- list("launch_speed" = Batting_Ohtani_100_ls_tyear, "launch_angle" = Batting_Ohtani_100_la_tyear, "spin_rate" = Pitching_Ohtani_spinrate_table_year)
write.xlsx(sheet, file = "Save_Ohtani_batting.xlsx",  rowNames = F)
...
plot(Pitching_Ohtani_CU$game_date, Pitching_Ohtani_CU$release_speed, type = 'l', lty = 1, lwd = 2, col = 'firebrick1', ylim = c(65,120), xlab = 'Year', ylab = 'release speed', main = "Shohei Ohtani's pitching speed(release) \nby date", cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5 )
lines(Pitching_Ohtani_FC$game_date, Pitching_Ohtani_FC$release_speed, type = 'l', lty = 1, lwd = 2, col = 'deeppink1')
lines(Pitching_Ohtani_FF$game_date, Pitching_Ohtani_FF$release_speed, type = 'l', lty = 1, lwd = 2, col = 'gold1')
lines(Pitching_Ohtani_FS$game_date, Pitching_Ohtani_FS$release_speed, type = 'l', lty = 1, lwd = 2, col = 'green3')
lines(Pitching_Ohtani_SL$game_date, Pitching_Ohtani_SL$release_speed, type = 'l', lty = 1, lwd = 2, col = 'dodgerblue2')
...
plot(Pitching_Ohtani_CU$game_date, Pitching_Ohtani_CU$release_spin_rate, type = 'l', lty = 1, lwd = 2, ylim = c(800,3500), col = 'firebrick1', xlab = 'Year', ylab = 'release spin rate', main = "Shohei Ohtani's pitching spin rate by date", cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5 )
lines(Pitching_Ohtani_FC$game_date, Pitching_Ohtani_FC$release_spin_rate, type = 'l', lty = 1, lwd = 2, col = 'deeppink1')
lines(Pitching_Ohtani_FF$game_date, Pitching_Ohtani_FF$release_spin_rate, type = 'l', lty = 1, lwd = 2, col = 'gold1')
lines(Pitching_Ohtani_FS$game_date, Pitching_Ohtani_FS$release_spin_rate, type = 'l', lty = 1, lwd = 2, col = 'green3')
lines(Pitching_Ohtani_SL$game_date, Pitching_Ohtani_SL$release_spin_rate, type = 'l', lty = 1, lwd = 2, col = 'dodgerblue2')
legend('topleft', c('Curve', 'Cutter', 'Fast', 'Split-finger', 'Slider'), col = c('firebrick1', 'deeppink1', 'gold1', 'green3', 'dodgerblue2'), lwd = 2, lty = 1)

par(mfrow = c(1,1))
##* Plotting scatter plot of Ohtani's release ball's position V.S. date (no detail check by pitching type)
plot(Pitching_Ohtani$game_date, Pitching_Ohtani$release_extension, type = 'l', lty = 1, lwd = 2, col = 'firebrick1', ylim = c(5,7.5), xlab = 'Year', ylab = 'Release extension(in feet)', main = "Shohei Ohtani's ball's release position \nby date", cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5 )

par(mfrow = c(1,1))
##* Plotting scatter plot of Ohtani's release ball's position V.S. date
plot(Pitching_Ohtani_CU$game_date, Pitching_Ohtani_CU$release_extension, type = 'l', lty = 1, lwd = 2, col = 'firebrick1', ylim = c(5,7.5), xlab = 'Year', ylab = 'Release extension(in feet)', main = "Shohei Ohtani's ball's release position \nby date", cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5 )
lines(Pitching_Ohtani_FC$game_date, Pitching_Ohtani_FC$release_extension, type = 'l', lty = 1, lwd = 2, col = 'deeppink1')
lines(Pitching_Ohtani_FF$game_date, Pitching_Ohtani_FF$release_extension, type = 'l', lty = 1, lwd = 2, col = 'gold1')
lines(Pitching_Ohtani_FS$game_date, Pitching_Ohtani_FS$release_extension, type = 'l', lty = 1, lwd = 2, col = 'green3')
lines(Pitching_Ohtani_SL$game_date, Pitching_Ohtani_SL$release_extension, type = 'l', lty = 1, lwd = 2, col = 'dodgerblue2')
...
plot(Pitching_Ohtani_CU$game_date, Pitching_Ohtani_CU$vx0, type = 'l', lty = 1, lwd = 2, col = 'firebrick1', ylim = c(-5,20), xlab = 'Year', ylab = 'vx0(in feet)', main = "Shohei Ohtani's pitching vx0 \nby date", cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5 )
lines(Pitching_Ohtani_FC$game_date, Pitching_Ohtani_FC$vx0, type = 'l', lty = 1, lwd = 2, col = 'deeppink1')
lines(Pitching_Ohtani_FF$game_date, Pitching_Ohtani_FF$vx0, type = 'l', lty = 1, lwd = 2, col = 'gold1')
lines(Pitching_Ohtani_FS$game_date, Pitching_Ohtani_FS$vx0, type = 'l', lty = 1, lwd = 2, col = 'green3')
lines(Pitching_Ohtani_SL$game_date, Pitching_Ohtani_SL$vx0, type = 'l', lty = 1, lwd = 2, col = 'dodgerblue2')
legend('topleft', c('Curve', 'Cutter', 'Fast', 'Split-finger', 'Slider'), col = c('firebrick1', 'deeppink1', 'gold1', 'green3', 'dodgerblue2'), lwd = 2, lty = 1)

par(mfrow = c(1,1))
##* Plotting scatter plot of Ohtani's vy0 V.S. date
plot(Pitching_Ohtani_CU$game_date, Pitching_Ohtani_CU$vy0, type = 'l', lty = 1, lwd = 2, col = 'firebrick1', ylim = c(-150,-70), xlab = 'Year', ylab = 'vy0(in feet)', main = "Shohei Ohtani's pitching vy0 \nby date", cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5 )
lines(Pitching_Ohtani_FC$game_date, Pitching_Ohtani_FC$vy0, type = 'l', lty = 1, lwd = 2, col = 'deeppink1')
lines(Pitching_Ohtani_FF$game_date, Pitching_Ohtani_FF$vy0, type = 'l', lty = 1, lwd = 2, col = 'gold1')
lines(Pitching_Ohtani_FS$game_date, Pitching_Ohtani_FS$vy0, type = 'l', lty = 1, lwd = 2, col = 'green3')
lines(Pitching_Ohtani_SL$game_date, Pitching_Ohtani_SL$vy0, type = 'l', lty = 1, lwd = 2, col = 'dodgerblue2')
...
plot(Pitching_Ohtani_CU$game_date, Pitching_Ohtani_CU$vz0, type = 'l', lty = 1, lwd = 2, col = 'firebrick1', ylim = c(-15,20), xlab = 'Year', ylab = 'vz0(in feet)', main = "Shohei Ohtani's pitching vz0 \nby date", cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5 )
lines(Pitching_Ohtani_FC$game_date, Pitching_Ohtani_FC$vz0, type = 'l', lty = 1, lwd = 2, col = 'deeppink1')
lines(Pitching_Ohtani_FF$game_date, Pitching_Ohtani_FF$vz0, type = 'l', lty = 1, lwd = 2, col = 'gold1')
lines(Pitching_Ohtani_FS$game_date, Pitching_Ohtani_FS$vz0, type = 'l', lty = 1, lwd = 2, col = 'green3')
lines(Pitching_Ohtani_SL$game_date, Pitching_Ohtani_SL$vz0, type = 'l', lty = 1, lwd = 2, col = 'dodgerblue2')
legend('topleft', c('Curve', 'Cutter', 'Fast', 'Split-finger', 'Slider'), col = c('firebrick1', 'deeppink1', 'gold1', 'green3', 'dodgerblue2'), lwd = 2, lty = 1)

par(mfrow = c(1,1))
##* Plotting scatter plot of Ohtani's spin_axis V.S. date
plot(Pitching_Ohtani_CU$game_date, Pitching_Ohtani_CU$spin_axis, type = 'l', lty = 1, lwd = 2, col = 'firebrick1', ylim = c(20,450), xlab = 'Year', ylab = 'spin_axis(in feet)', main = "Shohei Ohtani's pitching spin_axis \nby date", cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5 )
lines(Pitching_Ohtani_FC$game_date, Pitching_Ohtani_FC$spin_axis, type = 'l', lty = 1, lwd = 2, col = 'deeppink1')
lines(Pitching_Ohtani_FF$game_date, Pitching_Ohtani_FF$spin_axis, type = 'l', lty = 1, lwd = 2, col = 'gold1')
lines(Pitching_Ohtani_FS$game_date, Pitching_Ohtani_FS$spin_axis, type = 'l', lty = 1, lwd = 2, col = 'green3')
lines(Pitching_Ohtani_SL$game_date, Pitching_Ohtani_SL$spin_axis, type = 'l', lty = 1, lwd = 2, col = 'dodgerblue2')
legend('topleft', c('Curve', 'Cutter', 'Fast', 'Split-finger', 'Slider'), col = c('firebrick1', 'deeppink1', 'gold1', 'green3', 'dodgerblue2'), lwd = 2, lty = 1)
...
par(mfrow = c(1,1))
boxplot(launch_speed~year, data = Batting_Ohtani_100, col = c('mediumorchid3'), main = "Shohei Ohtani's batting launch speed \nby year", xlab = 'Year', ylab = 'Launch speed(mph)', cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5)
...
par(mfrow = c(1,1))
boxplot(launch_angle~year, data = Batting_Ohtani_100, col = c('mediumorchid3'), main = "Shohei Ohtani's batting launch angle \nby year", xlab = 'Year', ylab = 'Launch angle', cex.axis= 1.5, cex.lab= 1.5, cex.main =1.5)
...
legend("bottomleft", c("CH (-9.8)", "CU (-7.7)", "FA (NA)", "FC (+8)", "FF (+4)", "FO (NA)", "FS (-24.4)", "KC (-6.9)", "SI (3.3)", "SL (-6.5)"), col = c("red", "orange", "gold1", "limegreen", "cyan4", "darkorchid", "mediumorchid4", "olivedrab4", "seagreen", "tomato"), lty = 1, lwd =2, text.col = c("blue", "blue", "black", "black", "black", "black", "blue", "blue", "black", "blue"), pch = 19)
...
legend("bottomright", c("CH (-5.7)", "CU (-3.0)", "FA (NA)", "FC (-6.7)", "FF (-1.4)", "FO (NA)", "FS (16.3)", "KC (25.2)", "SI (-4.3)", "SL (-0.8)"), col = c("red", "orange", "gold1", "limegreen", "cyan4", "darkorchid", "mediumorchid4", "olivedrab4", "seagreen", "tomato"), lty = 1, lwd =2, text.col = c("blue", "black", "black", "blue", "black", "black", "black", "black", "blue", "blue"), pch = 19)
...
Launch_speed_FS_2021 <- Batting_Ohtani_100$launch_speed[Batting_Ohtani_100$pitch_type == 'FS' & Batting_Ohtani_100$year == '2021']
...
### Checking T test of Ohtani's exit velocity at CH in 2022 and not in 2022
t.test(Launch_speed_CH_2022, Launch_speed_CH_not2022)

### Checking T test of Ohtani's exit velocity at CU in 2022 and not in 2022
t.test(Launch_speed_CU_2022, Launch_speed_CU_not2022)

### Checking T test of Ohtani's launch angle at CH in 2022 and not in 2022
t.test(Launch_angle_CH_2022, Launch_angle_CH_not2022)

### Checking T test of Ohtani's launch angle at FC in 2022 and not in 2022
